...
# ===== dane =====
Q_DIR = "/scratch/tmp/1k_grid_neurips/new_flows_10s"
A_DIR = "/scratch/tmp/1k_grid_neurips/new_assignments_10s"
DATA_ROOT = "/scratch/tmp"
ADJDATA = "/scratch/tmp/21k_exps/21k_hex_adjacency_matrix.csv"

# ===== główny katalog pipeline =====
PIPELINE_ROOT = Path("/scratch/tmp/post_neurips_test")
...
FUSE_METHOD = "hadamard"    # "attention" / "concatenate" / "hadamard"
...
def collect_key_results():
    ...
    copy_if_exists(RUN_DIR / "data_old" / "learning_curves.png", training_summary_dir)
    copy_if_exists(RUN_DIR / "data_old" / "training_metrics.csv", training_summary_dir)
